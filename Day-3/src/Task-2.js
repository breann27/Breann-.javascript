...
const generateRandomExpenses = (numExpenses) => {
  ...
  for (let i = 0; i < numExpenses; i++) {
    const expense = {
      ...
      category: faker.helpers.arrayElement(["Food", "Travel", "EMI", "Shopping", "Bills"]),//A particularly helpful method is arrayElement() which returns a random element from an array.
